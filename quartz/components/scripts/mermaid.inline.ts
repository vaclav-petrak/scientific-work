  ...
  async function renderMermaid() {
    ...
    mermaid.initialize({
      ...
      themeVariables: {
        ...
        primaryTextColor: darkMode ? computedStyleMap["--dark"] : computedStyleMap["--darkgray"],
        primaryBorderColor: computedStyleMap["--secondary"],
        lineColor: computedStyleMap["--gray"],
        secondaryColor: computedStyleMap["--lightgray"],
        tertiaryColor: computedStyleMap["--highlight"],
        clusterBkg: computedStyleMap["--light"],
        edgeLabelBackground: computedStyleMap["--lightgray"],
        mainBkg: computedStyleMap["--light"],
        secondaryBorderColor: computedStyleMap["--tertiary"],
        tertiaryBorderColor: computedStyleMap["--gray"],
        nodeBorder: computedStyleMap["--secondary"],
        clusterBorder: computedStyleMap["--gray"],
        defaultLinkColor: computedStyleMap["--secondary"],
        titleColor: computedStyleMap["--dark"],
        nodeTextColor: darkMode ? computedStyleMap["--dark"] : computedStyleMap["--darkgray"],
        textColor: darkMode ? computedStyleMap["--dark"] : computedStyleMap["--darkgray"],
        labelTextColor: darkMode ? computedStyleMap["--dark"] : computedStyleMap["--darkgray"],
      },
    })
